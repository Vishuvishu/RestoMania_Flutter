...
TextStyle poppins = TextStyle(fontFamily: GoogleFonts.poppins().fontFamily);
TextStyle aclonica = TextStyle(fontFamily: GoogleFonts.aclonica().fontFamily);
TextStyle roboto = TextStyle(fontFamily: GoogleFonts.roboto().fontFamily);
TextStyle tenorSans = TextStyle(fontFamily: GoogleFonts.tenorSans().fontFamily);
...
//==============================================================================
  ...
  TextStyle get gold => textColor(AppColors.gold);
